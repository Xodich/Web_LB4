...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var detailButtons = document.querySelectorAll('.item-detail-btn');
  var currentIndex = -1;
  if (infoModal) {
    var modalInstance = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(infoModal);

    // Функция обновления контента модалки
    var updateModalContent = function updateModalContent(button) {
      ...
      var modalImg = infoModal.querySelector('#modalImg');
    ...
    document.addEventListener('keydown', function (event) {
      ...
      if (infoModal.classList.contains('show')) {
        ...
        if (nextIndex !== -1) {
          var nextButton = document.querySelector(".item-detail-btn[data-index=\"".concat(nextIndex, "\"]"));
          if (nextButton) {
